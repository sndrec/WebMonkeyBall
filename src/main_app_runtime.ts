...
const PROFILE_BROADCAST_COOLDOWN_MS = profileTiming.broadcastCooldownMs;
const PROFILE_REMOTE_COOLDOWN_MS = profileTiming.remoteCooldownMs;
const LOBBY_NAME_UPDATE_COOLDOWN_MS = profileTiming.lobbyNameUpdateCooldownMs;
const CHAT_MAX_MESSAGES = chatTiming.maxMessages;
const CHAT_SEND_COOLDOWN_MS = chatTiming.sendCooldownMs;
const CHAT_INGAME_VISIBLE_MS = chatTiming.ingameVisibleMs;
const CHAT_INGAME_FADE_MS = chatTiming.ingameFadeMs;
const NETPLAY_MAX_FRAME_DELTA = netplayConstants.maxFrameDelta;
const NETPLAY_CLIENT_LEAD = netplayConstants.clientLead;
const NETPLAY_CLIENT_AHEAD_SLACK = netplayConstants.clientAheadSlack;
const NETPLAY_CLIENT_RATE_MIN = netplayConstants.clientRateMin;
const NETPLAY_CLIENT_RATE_MAX = netplayConstants.clientRateMax;
const NETPLAY_CLIENT_DRIFT_RATE = netplayConstants.clientDriftRate;
const NETPLAY_DRIFT_FORCE_TICK = netplayConstants.driftForceTick;
const NETPLAY_DRIFT_EXTRA_TICKS = netplayConstants.driftExtraTicks;
const NETPLAY_CLIENT_MAX_EXTRA_LEAD = netplayConstants.clientMaxExtraLead;
const NETPLAY_SYNC_RATE_MIN = netplayConstants.syncRateMin;
const NETPLAY_SYNC_RATE_MAX = netplayConstants.syncRateMax;
const NETPLAY_SYNC_DRIFT_RATE = netplayConstants.syncDriftRate;
const NETPLAY_SYNC_FORCE_TICK = netplayConstants.syncForceTick;
const NETPLAY_SYNC_EXTRA_TICKS = netplayConstants.syncExtraTicks;
const NETPLAY_SYNC_MAX_TICKS = netplayConstants.syncMaxTicks;
const NETPLAY_STAGE_READY_RESEND_MS = netplayConstants.stageReadyResendMs;
const NETPLAY_STAGE_READY_TIMEOUT_MS = netplayConstants.stageReadyTimeoutMs;
const NETPLAY_LAG_FUSE_FRAMES = netplayConstants.lagFuseFrames;
const NETPLAY_LAG_FUSE_MS = netplayConstants.lagFuseMs;
const NETPLAY_SNAPSHOT_COOLDOWN_MS = netplayConstants.snapshotCooldownMs;
const NETPLAY_PING_INTERVAL_MS = netplayConstants.pingIntervalMs;
const NETPLAY_HOST_STALL_MS = netplayConstants.hostStallMs;
const NETPLAY_HOST_SNAPSHOT_BEHIND_FRAMES = netplayConstants.hostSnapshotBehindFrames;
const NETPLAY_HOST_SNAPSHOT_COOLDOWN_MS = netplayConstants.hostSnapshotCooldownMs;
const NETPLAY_SNAPSHOT_MISMATCH_COOLDOWN_MS = netplayConstants.snapshotMismatchCooldownMs;
const NETPLAY_MAX_INPUT_AHEAD = netplayConstants.maxInputAhead;
const NETPLAY_MAX_INPUT_BEHIND = netplayConstants.maxInputBehind;
const NETPLAY_HOST_MAX_INPUT_ROLLBACK = netplayConstants.hostMaxInputRollback;
const LOBBY_MAX_PLAYERS = multiplayerLimits.lobbyMaxPlayers;
const CHAINED_MAX_PLAYERS = multiplayerLimits.chainedMaxPlayers;
const MULTIPLAYER_MODE_STANDARD: MultiplayerGameMode = multiplayerModes.standard;
const MULTIPLAYER_MODE_CHAINED: MultiplayerGameMode = multiplayerModes.chained;
const NETPLAY_DEBUG_STORAGE_KEY = netplayDebugStorageKey;
const LOBBY_HEARTBEAT_INTERVAL_MS = lobbyHeartbeatTiming.intervalMs;
const LOBBY_HEARTBEAT_FALLBACK_MS = lobbyHeartbeatTiming.fallbackMs;
...
const {
  ...
  enabled: perfEnabled,
  storageKey: NETPLAY_DEBUG_STORAGE_KEY,
  game,
});
